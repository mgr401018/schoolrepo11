...
SELECT product_name, category_id FROM testproducts;
...
VALUES
 ...
 select customer_name, postal_code, country from customers c
 where c.country = 'Mexico' order by city desc nulls first;
 
insert into testproducts (category_id)
values(10);

delete from testproducts where product_name is null;